 ...
 */
export default abstract class MonkeyState extends State {

    protected parent: MonkeyController;
	protected owner: HW3AnimatedSprite;
    protected player: HW3AnimatedSprite;
	protected gravity: number;

	public constructor(parent: MonkeyController, owner: HW3AnimatedSprite){
		super(parent);
		this.owner = owner;
        this.gravity = 500;
	}
