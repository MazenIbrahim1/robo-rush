...
export default class Level4 extends HW3Level {
    ...
    public static readonly MONKEY_SPAWN0 = new Vec2(10656, 385);
    public static readonly MONKEY_SPAWN1 = new Vec2(11264, 385);
    public static readonly MONKEY_SPAWN2 = new Vec2(12160, 385);
    public static readonly MONKEY_SPAWN3 = new Vec2(12384, 385);
    public static readonly MONKEY_SPAWN4 = new Vec2(12608, 385);
    public static readonly MONKEY_SPAWN5 = new Vec2(12832, 385);
    ...
    public static readonly TILEMAP_PATH = "assets/tilemaps/level4final.json";
    ...
    public constructor(viewport: Viewport, sceneManager: SceneManager, renderingManager: RenderingManager, options: Record<string, any>) {
        ...
        this.backgroundKey = Level4.BACKGROUND_KEY;
        ...
        this.backgroundLayerKey = Level4.BACKGROUND_LAYER_KEY;
        ...
        this.monkeySpriteKey = Level4.MONKEY_SPRITE_KEY;
        this.monkey0 = Level4.MONKEY_SPAWN0;
        this.monkey1 = Level4.MONKEY_SPAWN1;
        this.monkey2 = Level4.MONKEY_SPAWN2;
        this.monkey3 = Level4.MONKEY_SPAWN3;
        this.monkey4 = Level4.MONKEY_SPAWN4;
        this.monkey5 = Level4.MONKEY_SPAWN5;
    ...
    public loadScene(): void {
        ...
        this.load.image(this.backgroundKey, Level4.BACKGROUND_PATH);
        // Load in the player's sprite
        this.load.spritesheet(this.playerSpriteKey, Level4.PLAYER_SPRITE_PATH);
        this.load.spritesheet(this.monkeySpriteKey, Level4.MONKEY_SPRITE_PATH);
        // Audio and music
